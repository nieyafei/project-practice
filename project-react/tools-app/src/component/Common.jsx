...
class CardReset extends Component{
  render(){
    console.log(this.props.children)
    return <Card {...this.props} className={"card-reset " + this.props.className}>{this.props.children}</Card>
  }
}

export {
  CommonRoot, PageBgComp, CardReset
}